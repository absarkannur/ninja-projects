<div>
    ...
    @script
        <script>
            $(".parallax-window").parallax({
                imageSrc: "{{ asset( 'storage/' . $contact_data->banner_image ) }}",
                zIndex: 1,
                speed: 0.2,
                iosDisabled: false,
            });
    ...
    <section class="section-home-contact">
        <div class="container">
            <div class="row">
                <div class="col-sm-12 col-md-12 col-lg-6 col-xl-6 address-wrap">
                    <div class="adds">
                        <h3>Address</h3>
                        <p>{{ $site_data->company_address }}</p>
                    </div>
                    <div class="adds">
                        <h3>Phone</h3>
                        <p>{{ $site_data->company_phone1 }}</p>
                        <p>{{ $site_data->company_phone2 }}</p>
                    </div>
                    <div class="adds">
                        <h3>Email</h3>
                        <p>{{ $site_data->company_email }}</p>
                    </div>
                    <div class="adds">
                        <h3>Social Media</h3>
    ...
    <section class="section-home-google-map">
        {!! $contact_data->google_map !!}
    </section>
