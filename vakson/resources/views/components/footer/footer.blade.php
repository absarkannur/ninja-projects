        ...
        <div class="row">
            <div class="col-sm-12 col-md-12 col-lg-3 col-xl-3">
                <ul class="footer-nav">
                    <li class="item">
                        <div>
                            <img src="{{ asset( 'vakson-assets/icons/logo.png' ) }}" height="60" alt="" />
                        </div>
                    </li>
                    <li class="item">
            ...
            <div class="col-sm-12 col-md-12 col-lg-3 col-xl-3">
                <ul class="footer-nav">
                    ...
                    <li class="item">Office 136, Block B, Emarat Atrium Building, Sheikh Zayed Road, Dubai, UAE.
                    </li>
                    <li class="item">info@vaksondevelopment.com</li>
                    <li class="item">+971 4 303 9222</li>
                    <li class="item">&nbsp;</li>
                    <li class="item">
