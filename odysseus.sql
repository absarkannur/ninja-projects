...
--
-- Host: localhost:8889
-- Generation Time: Nov 21, 2024 at 07:12 PM
...
(2, 1, 'Test Absar', '2024-11-21 13:32:54', '2024-11-21 13:33:10');
...
CREATE TABLE `services_categories_contents` (
  ...
  `service_category_contect_image` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
