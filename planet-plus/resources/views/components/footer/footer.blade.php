            ...
            <div class="col-lg-4 col-md-6 col-12">
                <div class="single-footer-items footer-logo-area">
                    <div class="footer-logo">
                        <a href="{{ route('home') }}"><img src="{{ asset( 'storage/' . $site_data->footer_logo ) }}" alt=""></a>
                    </div>
                    <div class="space20"></div>
                    <div class="heading1">
                        <p>We provide innovative IT solutions tailored for your business needs.</p>
                    </div>
            ...
            <div class="row align-items-center">
                <div class="col-md-5">
                    <div class="coppyright">
                        <p>Copyright {{ '@'.date("Y") }} Planet Plus Computer Trading L.L.C.All Rights Reserved</p>
                    </div>
                </div>
                <div class="col-md-7">
