...
--
-- Host: localhost:8889
-- Generation Time: Mar 23, 2025 at 09:36 AM
...
(1, 1, 398, 'Seevayi House', 'Mottambram, Puthiyangadi', 'Dubai', '000000', 'Costa Cafe , GBS Building', '0562364538', 0, '2025-03-21 03:56:34', '2025-03-21 03:58:52');
...
INSERT INTO `brands` (`id`, `brand_name`, `brand_slug`, `brand_description`, `created_at`, `updated_at`) VALUES
(3, 'Gifts By Anum', 'gifts-by-anum', NULL, '2025-03-20 00:58:21', '2025-03-21 03:25:13');
...
INSERT INTO `categories` (`id`, `category_name`, `category_slug`, `category_description`, `created_at`, `updated_at`) VALUES
(1, 'Cake', 'cake', NULL, '2025-03-20 03:40:06', '2025-03-20 04:25:03'),
(2, 'Flower', 'flower', NULL, '2025-03-20 04:54:36', '2025-03-20 04:54:36'),
(3, 'Printed Mug', 'printed-mug', NULL, '2025-03-22 01:06:30', '2025-03-22 01:06:30');
...
CREATE TABLE `customers` (
  ...
  `customer_email_verified_at` timestamp NULL DEFAULT NULL,
...
INSERT INTO `customers` (`id`, `customer_name`, `customer_email`, `customer_email_verified_at`, `customer_password`, `remember_token`, `created_at`, `updated_at`) VALUES
(1, 'Muhammed Absar Seeavyi', 'absar.design@gmail.com', NULL, '$2y$12$oJDIqmYXWhBhJitNMAoRUuSTJkggGVk9N1UBSRPMA76cA6OrKis7u', NULL, '2025-03-19 03:10:16', '2025-03-22 23:07:46'),
(4, 'Test Absar', 'absarkannur@gmail.com', NULL, '$2y$12$ymmi5NIBp2mvCfMnDCqAsuk4BwOrltTZCkWI49agggptfDkMguqYO', NULL, '2025-03-22 23:07:18', '2025-03-22 23:07:18');
...
CREATE TABLE `orders` (
  ...
  `customers_id` bigint(20) UNSIGNED NOT NULL,
  `shipping_methods_id` bigint(20) UNSIGNED NOT NULL,
...
INSERT INTO `orders` (`id`, `order_number`, `customers_id`, `shipping_methods_id`, `payment_types_id`, `order_status`, `order_date`, `created_at`, `updated_at`) VALUES
(1, 'ORD-000001', 1, 1, 3, 'new', '2025-03-23', '2025-03-23 01:33:45', '2025-03-23 02:53:31');
...
(1, 1, 1, 1, 160, 0, 5, 20, '2025-03-23 04:00:34', '2025-03-23 04:04:51');
...
INSERT INTO `payment_information` (`id`, `customers_id`, `payment_types_id`, `provider`, `card_no`, `expiry`, `created_at`, `updated_at`) VALUES
(1, 1, 4, 'Emirates Islamic Bank', '0000-0001-0002-0003', '03/26', '2025-03-21 04:20:27', '2025-03-22 02:31:27');
...
(3, 'Cash On Delivery', '2025-03-21 04:14:14', '2025-03-21 04:14:14'),
(4, 'Credit Card', '2025-03-21 04:14:26', '2025-03-21 04:14:26');
...
(1, 3, 2, NULL, NULL, 'Product 1', 'product-1', 'Nulla tincidunt erat lacus, a tempor est semper in. Proin ut ligula nulla.', NULL, '[]', 100, 160, 8, 'CK-01-', 1, '2025-03-23 03:58:37', '2025-03-23 03:58:37');
...
(1, 'Muhammed Absar', 'absarkannur@gmail.com', NULL, '$2y$12$Vr1kd8zyUahIPek3fyPBaumwfV1lcE9YngqF1nQcAjgQvse0gVKkW', NULL, '2025-03-19 02:17:26', '2025-03-19 02:27:46');
...
ALTER TABLE `customers`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `customers_email_unique` (`customer_email`);
