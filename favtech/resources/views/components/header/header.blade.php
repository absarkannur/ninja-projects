    ...
    <div class="top-bar">
        <div class="container-fluid">
            ...
            <span class="social-wrap">
                ...
                <span class="social-icon">
                    <a href="mailto:{{ $site_info->compnay_email }}" style="font-size: 11px;">
                ...
                <span class="social-icon">
                    <a href="tel:{{ $site_info->compnay_phone }}" style="font-size: 11px;">
                    ...
                    <span class="social-icon-group">
                        <a class="nav-link social" href="{{ $site_info->compnay_fb }}" target="_blank">
                            <div class="social-link">
                                <img src="{{ asset('fav/images/facebook.png') }}" alt="" />
                            </div>
                        </a>
                        <a class="nav-link social" href="{{ $site_info->compnay_insta }}" target="_blank">
                            <div class="social-link">
                                <img src="{{ asset('fav/images/insta.png') }}" alt="" />
                            </div>
                        </a>
                    </span>
