...
--
-- Host: localhost:3306
-- Generation Time: May 24, 2025 at 07:02 AM
...
(1, '10% Offer', '10% Offers for all users', 12, '2025-05-05', 'active', '2025-03-22 01:33:41', '2025-04-10 06:52:40'),
(2, 'Deal Of the Day', NULL, 50, '2025-05-04', 'active', '2025-05-17 21:45:01', '2025-05-17 21:45:01');
...
(2, 3, 2, 1, 1, 'Product 2', 'product-2', 'Test', NULL, '[\"cdn-products\\/01JV5H8WM1CJW28G09B6PAFJF4.jpg\"]', 290, 450, 54, 19.8, 10, 'SKU-GBA-CK-2', 1, '2025-03-24 04:11:12', '2025-05-21 01:40:33'),
(3, 3, 4, 1, 1, 'Product 3', 'product-3', 'Chees Cake', NULL, '[\"cdn-products\\/01JV5HBSKY938EB42NDTST6ZD9.png\"]', 230, 410, 49.2, 18.04, 10, 'SKU-GBA-CK-3', 1, '2025-03-28 23:31:17', '2025-05-20 03:03:06'),
...
CREATE TABLE `shipping_methods` (
  ...
  `shipping_condition` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `shipping_methods` (`id`, `shipping_title`, `shipping_condition`, `shipping_charge`, `shipping_description`, `created_at`, `updated_at`) VALUES
(1, 'Free Delivery', 'ABOVE_200', 0, 'Free Delivery', '2025-03-23 01:22:51', '2025-05-22 11:39:01'),
(4, 'Delivery Charge', 'BELOW_200', 20, NULL, '2025-05-22 11:40:07', '2025-05-22 11:40:07');
...
CREATE TABLE `sites` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `delivery_condition` double NOT NULL DEFAULT '0',
  `default_delivery_charge` double NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `sites` (`id`, `delivery_condition`, `default_delivery_charge`, `created_at`, `updated_at`) VALUES
(1, 200, 20, '2025-05-24 00:54:22', '2025-05-24 01:22:10');
