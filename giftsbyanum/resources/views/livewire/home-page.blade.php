<main class="home-page-wrapper">
    ...
    <div class="home-page-service-info">

        <div class="top-strip">
            <div class="container">
                <div class="content">
                    <span class="text">BIGGEST OFFER 15% OFF ON GIFT & ACCESSORIES. <a>SHOP NOW</a></span>
                    <span class="icon">
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-md-12 col-lg-3 col-xl-3">
                            ...
                            <div class="info">
                                ...
                                <div class="bx-2">
                                    <span class="hd-title">Around 24 hours</span>
                                    <span class="cn-title">On Time shipping</span>
                                </div>
                            </div>
                        ...
                        <div class="col-sm-12 col-md-12 col-lg-3 col-xl-3">
                            ...
                            <div class="info">
                                ...
                                <div class="bx-2">
                                    <span class="hd-title">Easy Orders</span>
                                    <span class="cn-title">On Time shipping</span>
                                </div>
                            </div>
                        ...
                        <div class="col-sm-12 col-md-12 col-lg-3 col-xl-3">
                            ...
                            <div class="info">
                                ...
                                <div class="bx-2">
                                    <span class="hd-title">Easy Orders</span>
                                    <span class="cn-title">Customer service</span>
                                </div>
                            </div>
                        ...
                        <div class="col-sm-12 col-md-12 col-lg-3 col-xl-3">
                            ...
                            <div class="info">
                                ...
                                <div class="bx-2">
                                    <span class="hd-title">We have</span>
                                    <span class="cn-title">Buyers protection</span>
                                </div>
                            </div>
    ...
    <div class="home-page-feauted-products">
        <div class="container">
            <div class="row">
                <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">

                    <div class="header-with-link">
                        <span class="title"><em class="white">Feauted Products</em></span>
                        <a class="link white" href="">More products</a>
                    </div>
    ...
    <div class="home-page-special-offer">
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                    ...
                    <div class="header-with-link">
                        <span class="title"><em class="offwhite">Special Offers</em></span>
                        <a class="link offwhite" href="">More products</a>
                    </div>
