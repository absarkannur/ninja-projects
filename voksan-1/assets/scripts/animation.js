jQuery(document).ready(function ($) {
  ...
  function timeSection() {
    $(".timeline-wrapper h2.header")
      .removeClass("visible-hidden")
      .addClass("animate__fadeInUp");
    $(".timeline-wrapper .image-wrap")
      .removeClass("visible-hidden")
      .addClass("animate__fadeInUp");
  }
  ...
  function projectSection() {
    $(".project-wrapper h2.header")
      .removeClass("visible-hidden")
      .addClass("animate__fadeInUp");
    $(".project-wrapper h3.sub-header")
      .removeClass("visible-hidden")
      .addClass("animate__fadeInUp");
    $(".project-wrapper .property-slider")
      .removeClass("visible-hidden")
      .addClass("animate__fadeInUp");
  }
