<main class="contact-inner-wrapper bg-blue">

    <section class="container-fluid innerpage-banner" style="background-image: url({{ asset( 'odys_assets/images/contact.png' ) }})">
        <div class="container">
            <h1 class="heading-inner">Contact Us</h1>
        </div>
    </section>
            ...
            <div class="row">
                <div class="col-sm-12 col-md-12 col-lg-7 col-xl-7">
                    <div class="contact-info">
                        <h2>Get In Touch</h2>
                        <p>Let’s build the blueprint for your growth journey together. Whether you’re looking to craft compelling strategies, elevate your storytelling, or ignite innovation, we’re here to help. Reach out to discover how we can fuel your sustainable success.</p>
